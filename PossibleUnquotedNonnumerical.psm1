...
function Measure-PossibleUnquotedNonnumerical {
<#
    .SYNOPSIS
    Nonnumericals need to be quoted.
    .DESCRIPTION
    Nonnumericals (as version, date and ipaddress) types need to be quoted otherwise they
    will be seen as a number (double type) with a property member after the second dot.
    .INPUTS
...
#>
    ...
    Process {
        ...
        Foreach ($Violation in $Violations) {
            ...
            [Microsoft.Windows.PowerShell.ScriptAnalyzer.Generic.DiagnosticRecord]@{
                Message              = "Nonnumericals need to be quoted: '$Extent'"
                Extent               = $Extent
                RuleName             = 'PSPossibleUnquotedNonnumerical'
                Severity             = 'Warning'
